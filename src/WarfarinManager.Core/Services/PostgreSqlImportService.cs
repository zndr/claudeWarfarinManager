...
public class PostgreSqlImportService
{
    ...
    public async Task<List<MillepsPatientDto>> ImportPatientsAsync(string codiceFiscaleMedico)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("Connessione stabilita. Esecuzione query importazione pazienti...");
